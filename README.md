...
if game.CoreGui:FindFirstChild("PEPOX HUP") then
    game.CoreGui:FindFirstChild("PEPOX HUP"):Destroy()
end
...
function Blacklib:Window()
    ...
    BlackImage.Image = "rbxassetid://11289419638/309500911"
